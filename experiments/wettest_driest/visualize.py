...
def write_details_json(fine_grids, output='etopo_details.json'):
    _write_json({'fine_grids': fine_grids}, output)
...
if __name__ == '__main__':
    ...
    write_details_json(fine_grids, output=args.details_output)
